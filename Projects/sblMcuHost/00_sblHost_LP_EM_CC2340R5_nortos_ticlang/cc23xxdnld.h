...
// intended to ease the integration of the CC23xx bootloader functionality
// in a host processor connected to the CC23xx UART[Use Cases]
// (@ref USE_CASES).
//
// # General Behavior #
// Before using the CcDnld API:
//   - A binary image should be prepared that is to be loaded into the CC23xx
//       Flash.
//  .
// To load data to the CC23xx Flash one should:
...
/// \brief defines CC23xx Flash Page Size
#define CCNDLD_CC23XX_PAGE_SIZE                 (0x800) // 2048
...
#define CCDNLD_CC13X4_CCFG_ADDRESS              0x50000000
#define CCDNLD_CC23XX_CCFG_ADDRESS              0x4e020000

#define DEVICE_CC23XX "cc23xx"
...
typedef enum
{
        ...
        CcDnld_Status_NotImplemented        = 5,
} CcDnld_Status;
...
//*****************************************************************************
//
//! \brief Erases entire flash, retains any sectors specified in CCFG.
//!
...
//!
//! This function Loads a chunk of data into the CC23xx Flash through the
//! ROM bootloader
//!
//! \param startAddress - The Flash start address.
